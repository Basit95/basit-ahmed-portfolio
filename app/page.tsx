...
const technologyRail = [
  ...
  { name: "Shopify", icon: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/shopify.svg" },
    ...
    <main>
      ...
      <section className="hero page-shell" id="home">
        <div className="hero-copy">
          <div className="eyebrow reveal-up"><span className="status-dot" /> Available for remote, relocation, and visa-sponsored opportunities worldwide.</div>
