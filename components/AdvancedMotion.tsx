...
const parallaxGroups = [
  ...
  { selector: ".project-detail-actions", factor: -0.05 },
];
    ...
    const updateParallax = () => {
      ...
      frame = requestAnimationFrame(() => {
        ...
        targets.forEach(({ element, factor }) => {
          ...
          if (box.bottom < -160 || box.top > window.innerHeight + 160) return;

          const elementCenter = box.top + box.height / 2;
          const movement = Math.max(-52, Math.min(52, (viewportCenter - elementCenter) * factor));
